...
<br>
Sonsuz Dijital Bahçeni İnşa Et
<br><br>
...
SiYuan'dan fork'lanmış, yerel öncelikli kişisel bilgi yönetim sistemi.

## 🚀 Sürüm

Önce bir daldan etiket oluşturun, ardından CI derlemesini ve Docker imaj derlemesini tetiklemek için etiketi itin. Etiket örneği: v0.0.0
...
Ardından dev'i main'e birleştirin veya main'e itin.

## Docker imajı yayınlama
...
Derlemeden sonra kurulum dosyası `build` klasöründedir.
